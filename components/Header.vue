  ...
  <v-app-bar>
    ...
    <v-content app>
      ...
      <nuxt-link
        ...
        :to="link.route"
      >
        <v-btn text class="mr-2">{{ link.text }}</v-btn>
        <v-icon v-text="link.icon" right></v-icon>
    </nuxt-link>-->
